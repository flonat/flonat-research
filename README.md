...
|-----------|-------|-------------|
| **Skills** | 87 | Portable workflows for common tasks (`proofread`, `latex`, `literature`, etc.) |
...
87 skills available. Key examples: `proofread`, `latex`, `pre-submission-report`, and more. Use `/name` in Claude, `$name` in Codex, or natural language; see [`docs/availability.md`](docs/availability.md).
<!-- SKILLS-SUMMARY:END -->
...
├── skills/                      # 87 client-neutral workflows
